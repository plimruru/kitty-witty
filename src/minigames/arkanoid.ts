...
/**
 * Arkanoid — классический арканоид с ракушками.
 * Платформа управляется мышью, мяч разбивает блоки-ракушки.
 * Нужно разбить все ракушки, чтобы получить ласты и перчатки.
 */
export class Arkanoid extends MiniGameBase {
    ...
    constructor(scene: Phaser.Scene, options: MiniGameOptions) {
        ...
        this.createTitle('Разбей ракушки', 'Разбей все ракушки мячом. Не дай мячу упасть!')
    ...
    protected restart(): void {
        new Arkanoid(this.scene, this.options)
    }
}
